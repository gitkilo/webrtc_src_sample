...
extern PROTOBUF_INTERNAL_EXPORT_config_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<7> scc_info_Controller_config_2eproto;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<7> scc_info_Controller_config_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 7, InitDefaultsscc_info_Controller_config_2eproto}, {
